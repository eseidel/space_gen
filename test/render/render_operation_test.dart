  ...
  group('parameters', () {
    ...
    test('validation statements', () {
      ...
      expect(
        ...
        '    ) async {\n'
        "        foo?.validate(minLength: 1, maxLength: 10, pattern: '^[a-z]+\\\$');\n"
        '        bar?.validate(min: 1, max: 10, exclusiveMin: 1, exclusiveMax: 10, multipleOf: 2);\n'
        '        baz?.validate(min: 0.1, max: 10.0, exclusiveMin: 0.1, exclusiveMax: 10.2, multipleOf: 0.1);\n'
        '\n'
        '        final response = await client.invokeApi(\n'
        '            method: Method.post,\n'
        "            path: '/users',\n"

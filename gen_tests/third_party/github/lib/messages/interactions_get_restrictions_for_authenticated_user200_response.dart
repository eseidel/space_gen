...
import 'package:github/models/interactions_get_restrictions_for_authenticated_user200_response_any_of_1.dart';
...
sealed class InteractionsGetRestrictionsForAuthenticatedUser200Response {
  ...
  factory InteractionsGetRestrictionsForAuthenticatedUser200Response.fromJson(
    ...
    return InteractionsGetRestrictionsForAuthenticatedUser200ResponseVariant1(
...
@immutable
final class InteractionsGetRestrictionsForAuthenticatedUser200ResponseVariant1
    extends InteractionsGetRestrictionsForAuthenticatedUser200Response {
  const InteractionsGetRestrictionsForAuthenticatedUser200ResponseVariant1(
    this.value,
  );
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other
            is InteractionsGetRestrictionsForAuthenticatedUser200ResponseVariant1 &&
        value == other.value;
  }
}

...
class PagesHealthCheckAltDomain {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (dnsResolves != null) 'dns_resolves': dnsResolves,
      ...
      if (isValidDomain != null) 'is_valid_domain': isValidDomain,
      if (isApexDomain != null) 'is_apex_domain': isApexDomain,
      ...
      if (isPagesDomain != null) 'is_pages_domain': isPagesDomain,
      'is_served_by_pages': isServedByPages,
      if (isValid != null) 'is_valid': isValid,
      'reason': reason,
      if (respondsToHttps != null) 'responds_to_https': respondsToHttps,
      if (enforcesHttps != null) 'enforces_https': enforcesHttps,

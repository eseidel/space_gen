...
import 'package:github/models/checks_create_request_one_of_1_output_annotations_inner_annotation_level.dart';
import 'package:meta/meta.dart';

@immutable
class ChecksCreateRequestOneOf1OutputAnnotationsInner {
  const ChecksCreateRequestOneOf1OutputAnnotationsInner({
    required this.path,
  ...
  /// [ChecksCreateRequestOneOf1OutputAnnotationsInner].
  factory ChecksCreateRequestOneOf1OutputAnnotationsInner.fromJson(
  ...
  static ChecksCreateRequestOneOf1OutputAnnotationsInner? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ChecksCreateRequestOneOf1OutputAnnotationsInner.fromJson(json);
  }
  ...
  final ChecksCreateRequestOneOf1OutputAnnotationsInnerAnnotationLevel
  annotationLevel;
  ...
  /// Converts a [ChecksCreateRequestOneOf1OutputAnnotationsInner]
  ...
  bool operator ==(Object other) {
    ...
    return other is ChecksCreateRequestOneOf1OutputAnnotationsInner &&
        path == other.path &&

...
import 'package:github/models/checks_update_request_any_of_1_output_annotations_inner_annotation_level.dart';
import 'package:meta/meta.dart';

@immutable
class ChecksUpdateRequestAnyOf1OutputAnnotationsInner {
  const ChecksUpdateRequestAnyOf1OutputAnnotationsInner({
    required this.path,
  ...
  /// [ChecksUpdateRequestAnyOf1OutputAnnotationsInner].
  factory ChecksUpdateRequestAnyOf1OutputAnnotationsInner.fromJson(
  ...
  static ChecksUpdateRequestAnyOf1OutputAnnotationsInner? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ChecksUpdateRequestAnyOf1OutputAnnotationsInner.fromJson(json);
  }
  ...
  final ChecksUpdateRequestAnyOf1OutputAnnotationsInnerAnnotationLevel
  annotationLevel;
  ...
  /// Converts a [ChecksUpdateRequestAnyOf1OutputAnnotationsInner]
  ...
  bool operator ==(Object other) {
    ...
    return other is ChecksUpdateRequestAnyOf1OutputAnnotationsInner &&
        path == other.path &&

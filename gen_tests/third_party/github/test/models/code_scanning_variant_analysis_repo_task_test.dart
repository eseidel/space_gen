...
void main() {
  group('CodeScanningVariantAnalysisRepoTask', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodeScanningVariantAnalysisRepoTask(
      ...
      final parsed = CodeScanningVariantAnalysisRepoTask.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(CodeScanningVariantAnalysisRepoTask.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodeScanningVariantAnalysisRepoTask.maybeFromJson(
          <String, dynamic>{},
        ),

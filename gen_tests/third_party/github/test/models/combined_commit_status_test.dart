...
void main() {
  group('CombinedCommitStatus', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CombinedCommitStatus(
        state: 'example',
        ...
        commitUrl: Uri.parse('https://example.com'),
        url: Uri.parse('https://example.com'),
      );
      final parsed = CombinedCommitStatus.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(CombinedCommitStatus.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CombinedCommitStatus.maybeFromJson(<String, dynamic>{}),

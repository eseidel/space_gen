...
void main() {
  group('PullRequestSimpleBase', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestSimpleBase(
        label: 'example',
        ref: 'example',
        repo: Repository(
          id: 42,
      ...
      final parsed = PullRequestSimpleBase.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestSimpleBase.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestSimpleBase.maybeFromJson(<String, dynamic>{}),

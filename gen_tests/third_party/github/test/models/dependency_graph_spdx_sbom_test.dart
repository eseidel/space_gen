...
void main() {
  group('DependencyGraphSpdxSbom', () {
    test('round-trips via maybeFromJson/toJson', () {
      const instance = DependencyGraphSpdxSbom(
      ...
      final parsed = DependencyGraphSpdxSbom.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(DependencyGraphSpdxSbom.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => DependencyGraphSpdxSbom.maybeFromJson(<String, dynamic>{}),

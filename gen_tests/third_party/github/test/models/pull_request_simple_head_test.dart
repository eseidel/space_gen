...
void main() {
  group('PullRequestSimpleHead', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestSimpleHead(
        label: 'example',
        ref: 'example',
        repo: Repository(
          id: 42,
      ...
      final parsed = PullRequestSimpleHead.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestSimpleHead.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestSimpleHead.maybeFromJson(<String, dynamic>{}),

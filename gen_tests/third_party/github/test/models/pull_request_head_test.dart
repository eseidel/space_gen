...
void main() {
  group('PullRequestHead', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestHead(
        label: 'example',
        ref: 'example',
        repo: Repository(
          id: 42,
      ...
      final parsed = PullRequestHead.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestHead.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestHead.maybeFromJson(<String, dynamic>{}),

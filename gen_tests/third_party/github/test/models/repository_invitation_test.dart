...
void main() {
  group('RepositoryInvitation', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = RepositoryInvitation(
        id: 42,
        ...
        permissions: RepositoryInvitationPermissions.read,
        createdAt: DateTime.utc(2024),
        url: 'https://api.github.com/user/repository-invitations/1',
        htmlUrl: 'https://github.com/octocat/Hello-World/invitations',
        nodeId: 'example',
      );
      final parsed = RepositoryInvitation.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(RepositoryInvitation.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => RepositoryInvitation.maybeFromJson(<String, dynamic>{}),

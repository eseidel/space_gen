...
void main() {
  group('UserRoleAssignment', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = UserRoleAssignment(
        login: 'octocat',
        id: 1,
        nodeId: 'MDQ6VXNlcjE=',
      ...
      final parsed = UserRoleAssignment.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(UserRoleAssignment.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => UserRoleAssignment.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('CheckSuitePreference', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CheckSuitePreference(
        preferences: const CheckSuitePreferencePreferences(),
      ...
      final parsed = CheckSuitePreference.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(CheckSuitePreference.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CheckSuitePreference.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('ProjectCard', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ProjectCard(
        url: Uri.parse('https://example.com'),
        id: 42,
        nodeId: 'MDExOlByb2plY3RDYXJkMTQ3OA==',
        ...
        columnUrl: Uri.parse('https://example.com'),
        projectUrl: Uri.parse('https://example.com'),
      );
      final parsed = ProjectCard.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(ProjectCard.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => ProjectCard.maybeFromJson(<String, dynamic>{}),

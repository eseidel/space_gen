...
void main() {
  group('PageBuild', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PageBuild(
        url: Uri.parse('https://example.com'),
        status: 'example',
        error: const PageBuildError(message: 'example'),
        pusher: SimpleUser(
          login: 'octocat',
          id: 1,
          nodeId: 'MDQ6VXNlcjE=',
      ...
      final parsed = PageBuild.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PageBuild.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PageBuild.maybeFromJson(<String, dynamic>{}),

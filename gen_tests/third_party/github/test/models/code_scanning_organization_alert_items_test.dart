...
void main() {
  group('CodeScanningOrganizationAlertItems', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodeScanningOrganizationAlertItems(
      ...
      final parsed = CodeScanningOrganizationAlertItems.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(CodeScanningOrganizationAlertItems.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodeScanningOrganizationAlertItems.maybeFromJson(
          <String, dynamic>{},
        ),

...
void main() {
  group('ScopedInstallation', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ScopedInstallation(
        permissions: const AppPermissions(),
        repositorySelection: ScopedInstallationRepositorySelection.all,
      ...
      final parsed = ScopedInstallation.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(ScopedInstallation.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => ScopedInstallation.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('TeamOrganization', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = TeamOrganization(
        login: 'github',
        id: 1,
      ...
      final parsed = TeamOrganization.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(TeamOrganization.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => TeamOrganization.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('CodespaceWithFullRepository', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespaceWithFullRepository(
        id: 1,
        name: 'monalisa-octocat-hello-world-g4wpq6h95q',
        environmentId: '26a7c758-7299-4a73-b978-5a92a7ae98a0',
        owner: SimpleUser(
          login: 'octocat',
          id: 1,
          nodeId: 'MDQ6VXNlcjE=',
        ...
        machine: const CodespaceMachine(
          name: 'standardLinux',
        ...
        createdAt: DateTime.utc(2024),
        updatedAt: DateTime.utc(2024),
        lastUsedAt: DateTime.utc(2024),
        state: CodespaceWithFullRepositoryState.unknown,
        url: Uri.parse('https://example.com'),
        gitStatus: const CodespaceWithFullRepositoryGitStatus(),
        location: CodespaceWithFullRepositoryLocation.eastUs,
        idleTimeoutMinutes: 60,
        webUrl: Uri.parse('https://example.com'),
        machinesUrl: Uri.parse('https://example.com'),
        startUrl: Uri.parse('https://example.com'),
        stopUrl: Uri.parse('https://example.com'),
        pullsUrl: Uri.parse('https://example.com'),
        recentFolders: const <String>['example'],
      );
      final parsed = CodespaceWithFullRepository.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(CodespaceWithFullRepository.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodespaceWithFullRepository.maybeFromJson(<String, dynamic>{}),

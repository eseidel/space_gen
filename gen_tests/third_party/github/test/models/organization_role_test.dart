...
void main() {
  group('OrganizationRole', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = OrganizationRole(
        id: 0,
        name: 'example',
      ...
      final parsed = OrganizationRole.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(OrganizationRole.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => OrganizationRole.maybeFromJson(<String, dynamic>{}),

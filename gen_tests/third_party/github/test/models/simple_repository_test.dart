...
void main() {
  group('SimpleRepository', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = SimpleRepository(
        id: 1296269,
      ...
      final parsed = SimpleRepository.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(SimpleRepository.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => SimpleRepository.maybeFromJson(<String, dynamic>{}),

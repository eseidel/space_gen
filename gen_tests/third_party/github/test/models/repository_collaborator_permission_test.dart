...
void main() {
  group('RepositoryCollaboratorPermission', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = RepositoryCollaboratorPermission(
        permission: 'example',
        roleName: 'admin',
        user: Collaborator(
          login: 'octocat',
      ...
      final parsed = RepositoryCollaboratorPermission.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(RepositoryCollaboratorPermission.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () =>
            RepositoryCollaboratorPermission.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('AppsListReposAccessibleToInstallation200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = AppsListReposAccessibleToInstallation200Response(
        totalCount: 0,
      ...
      final parsed =
          AppsListReposAccessibleToInstallation200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        AppsListReposAccessibleToInstallation200Response.maybeFromJson(null),
        isNull,
      );
    });

...
void main() {
  group('CodespacesListForAuthenticatedUser200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesListForAuthenticatedUser200Response(
        totalCount: 0,
      ...
      final parsed =
          CodespacesListForAuthenticatedUser200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        CodespacesListForAuthenticatedUser200Response.maybeFromJson(null),
        isNull,
      );
    });

...
void main() {
  group('CodespacesListRepositoriesForSecretForAuthenticatedUser200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesListRepositoriesForSecretForAuthenticatedUser200Response(
        totalCount: 0,
      ...
      final parsed =
          CodespacesListRepositoriesForSecretForAuthenticatedUser200Response.maybeFromJson(
            instance.toJson(),
          )!;

...
void main() {
  group('SearchCommits200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = SearchCommits200Response(
        totalCount: 0,
        ...
        items: <CommitSearchResultItem>[
          CommitSearchResultItem(
            ...
            committer: const GitUser(),
            parents: const <CommitSearchResultItemParentsInner>[
      ...
      final parsed = SearchCommits200Response.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(SearchCommits200Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => SearchCommits200Response.maybeFromJson(<String, dynamic>{}),

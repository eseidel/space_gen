...
void main() {
  group('ActionsListSelectedReposForOrgVariable200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListSelectedReposForOrgVariable200Response(
        totalCount: 0,
      ...
      final parsed =
          ActionsListSelectedReposForOrgVariable200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        ActionsListSelectedReposForOrgVariable200Response.maybeFromJson(null),
        isNull,
      );
    });

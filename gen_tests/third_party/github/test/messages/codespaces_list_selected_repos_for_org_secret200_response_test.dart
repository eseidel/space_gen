...
void main() {
  group('CodespacesListSelectedReposForOrgSecret200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesListSelectedReposForOrgSecret200Response(
        totalCount: 0,
      ...
      final parsed =
          CodespacesListSelectedReposForOrgSecret200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        CodespacesListSelectedReposForOrgSecret200Response.maybeFromJson(null),
        isNull,
      );
    });

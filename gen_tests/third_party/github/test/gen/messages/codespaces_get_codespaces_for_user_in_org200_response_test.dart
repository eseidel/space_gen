...
void main() {
  group('CodespacesGetCodespacesForUserInOrg200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesGetCodespacesForUserInOrg200Response(
        totalCount: 0,
      ...
      final parsed =
          CodespacesGetCodespacesForUserInOrg200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        CodespacesGetCodespacesForUserInOrg200Response.maybeFromJson(null),
        isNull,
      );
    });

...
void main() {
  group('DependabotListSelectedReposForOrgSecret200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = DependabotListSelectedReposForOrgSecret200Response(
        totalCount: 0,
      ...
      final parsed =
          DependabotListSelectedReposForOrgSecret200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        DependabotListSelectedReposForOrgSecret200Response.maybeFromJson(null),
        isNull,
      );
    });

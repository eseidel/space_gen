...
void main() {
  group('ActionsListRepoAccessToSelfHostedRunnerGroupInOrg200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListRepoAccessToSelfHostedRunnerGroupInOrg200Response(
        totalCount: 0,
      ...
      final parsed =
          ActionsListRepoAccessToSelfHostedRunnerGroupInOrg200Response.maybeFromJson(
            instance.toJson(),
          )!;

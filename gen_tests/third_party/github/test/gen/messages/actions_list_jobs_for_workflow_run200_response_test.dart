...
void main() {
  group('ActionsListJobsForWorkflowRun200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListJobsForWorkflowRun200Response(
        totalCount: 0,
        jobs: <Job>[
          Job(
            id: 21,
      ...
      final parsed = ActionsListJobsForWorkflowRun200Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        ActionsListJobsForWorkflowRun200Response.maybeFromJson(null),
        isNull,
      );
    });
    ...
    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => ActionsListJobsForWorkflowRun200Response.maybeFromJson(
          <String, dynamic>{},
        ),

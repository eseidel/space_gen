...
void main() {
  group('ActionsListWorkflowRunsForRepo200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListWorkflowRunsForRepo200Response(
        totalCount: 0,
      ...
      final parsed = ActionsListWorkflowRunsForRepo200Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        ActionsListWorkflowRunsForRepo200Response.maybeFromJson(null),
        isNull,
      );
    });
    ...
    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => ActionsListWorkflowRunsForRepo200Response.maybeFromJson(
          <String, dynamic>{},
        ),

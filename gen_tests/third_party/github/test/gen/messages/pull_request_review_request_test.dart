...
void main() {
  group('PullRequestReviewRequest', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestReviewRequest(
        users: <SimpleUser>[
          SimpleUser(
            login: 'octocat',
            id: 1,
      ...
      final parsed = PullRequestReviewRequest.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestReviewRequest.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestReviewRequest.maybeFromJson(<String, dynamic>{}),

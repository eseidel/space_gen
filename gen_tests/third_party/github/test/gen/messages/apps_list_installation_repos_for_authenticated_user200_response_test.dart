...
void main() {
  group('AppsListInstallationReposForAuthenticatedUser200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = AppsListInstallationReposForAuthenticatedUser200Response(
        totalCount: 0,
      ...
      final parsed =
          AppsListInstallationReposForAuthenticatedUser200Response.maybeFromJson(
            instance.toJson(),
          )!;

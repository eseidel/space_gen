...
void main() {
  group('CodespacesListInOrganization200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesListInOrganization200Response(
        totalCount: 0,
        codespaces: <Codespace>[
          Codespace(
            ...
            state: CodespaceState.unknown,
            url: Uri.parse('https://example.com'),
            gitStatus: const CodespaceGitStatus(),
            location: CodespaceLocation.eastUs,
      ...
      final parsed = CodespacesListInOrganization200Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        CodespacesListInOrganization200Response.maybeFromJson(null),
        isNull,
      );
    });
    ...
    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodespacesListInOrganization200Response.maybeFromJson(
          <String, dynamic>{},
        ),

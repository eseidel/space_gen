...
void main() {
  group('ActionsListSelectedReposForOrgSecret200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListSelectedReposForOrgSecret200Response(
        totalCount: 0,
      ...
      final parsed =
          ActionsListSelectedReposForOrgSecret200Response.maybeFromJson(
            instance.toJson(),
          )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        ActionsListSelectedReposForOrgSecret200Response.maybeFromJson(null),
        isNull,
      );
    });

...
void main() {
  group('CodespacesListInRepositoryForAuthenticatedUser200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodespacesListInRepositoryForAuthenticatedUser200Response(
        totalCount: 0,
      ...
      final parsed =
          CodespacesListInRepositoryForAuthenticatedUser200Response.maybeFromJson(
            instance.toJson(),
          )!;

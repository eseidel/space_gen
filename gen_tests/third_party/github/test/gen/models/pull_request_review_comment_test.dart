...
void main() {
  group('PullRequestReviewComment', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestReviewComment(
        url:
      ...
      final parsed = PullRequestReviewComment.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestReviewComment.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestReviewComment.maybeFromJson(<String, dynamic>{}),

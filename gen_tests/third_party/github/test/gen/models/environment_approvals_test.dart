...
void main() {
  group('EnvironmentApprovals', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = EnvironmentApprovals(
        environments: const <EnvironmentApprovalsEnvironmentsInner>[
          EnvironmentApprovalsEnvironmentsInner(),
        ],
        state: EnvironmentApprovalsState.approved,
        user: SimpleUser(
          login: 'octocat',
          id: 1,
          nodeId: 'MDQ6VXNlcjE=',
      ...
      final parsed = EnvironmentApprovals.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(EnvironmentApprovals.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => EnvironmentApprovals.maybeFromJson(<String, dynamic>{}),

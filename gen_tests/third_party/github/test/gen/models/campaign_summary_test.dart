...
void main() {
  group('CampaignSummary', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CampaignSummary(
        number: 0,
        ...
        contactLink: Uri.parse('https://example.com'),
      );
      final parsed = CampaignSummary.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(CampaignSummary.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CampaignSummary.maybeFromJson(<String, dynamic>{}),

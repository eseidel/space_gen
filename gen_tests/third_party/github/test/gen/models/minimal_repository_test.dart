...
void main() {
  group('MinimalRepository', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = MinimalRepository(
        id: 1296269,
      ...
      final parsed = MinimalRepository.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(MinimalRepository.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => MinimalRepository.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('StarredRepository', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = StarredRepository(
        starredAt: DateTime.utc(2024),
        repo: Repository(
          id: 42,
      ...
      final parsed = StarredRepository.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(StarredRepository.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => StarredRepository.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('CodeScanningVariantAnalysis', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodeScanningVariantAnalysis(
        id: 0,
        ...
        queryLanguage: CodeScanningVariantAnalysisLanguage.cpp,
        queryPackUrl: 'example',
        status: CodeScanningVariantAnalysisStatus1.inProgress,
      );
      final parsed = CodeScanningVariantAnalysis.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(CodeScanningVariantAnalysis.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodeScanningVariantAnalysis.maybeFromJson(<String, dynamic>{}),

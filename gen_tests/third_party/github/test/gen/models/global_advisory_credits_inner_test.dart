...
void main() {
  group('GlobalAdvisoryCreditsInner', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = GlobalAdvisoryCreditsInner(
        user: SimpleUser(
          login: 'octocat',
          id: 1,
          nodeId: 'MDQ6VXNlcjE=',
      ...
      final parsed = GlobalAdvisoryCreditsInner.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(GlobalAdvisoryCreditsInner.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => GlobalAdvisoryCreditsInner.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('PullRequestReview', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PullRequestReview(
        id: 42,
        ...
        links: const PullRequestReviewLinks(
      ...
      final parsed = PullRequestReview.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PullRequestReview.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PullRequestReview.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('RepositoryAdvisoryCredit', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = RepositoryAdvisoryCredit(
        user: SimpleUser(
          login: 'octocat',
          id: 1,
          nodeId: 'MDQ6VXNlcjE=',
        ...
        state: RepositoryAdvisoryCreditState.accepted,
      );
      final parsed = RepositoryAdvisoryCredit.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(RepositoryAdvisoryCredit.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => RepositoryAdvisoryCredit.maybeFromJson(<String, dynamic>{}),

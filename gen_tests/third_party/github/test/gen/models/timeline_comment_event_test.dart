...
void main() {
  group('TimelineCommentEvent', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = TimelineCommentEvent(
        event: 'example',
        actor: SimpleUser(
          login: 'octocat',
          id: 1,
      ...
      final parsed = TimelineCommentEvent.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(TimelineCommentEvent.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => TimelineCommentEvent.maybeFromJson(<String, dynamic>{}),

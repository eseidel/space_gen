...
void main() {
  group('CodeSearchResultItem', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = CodeSearchResultItem(
        name: 'example',
        path: 'example',
        sha: 'example',
      ...
      final parsed = CodeSearchResultItem.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(CodeSearchResultItem.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CodeSearchResultItem.maybeFromJson(<String, dynamic>{}),

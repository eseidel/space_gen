...
import 'package:spacetraders/models/get_status200_response_announcements_inner.dart';
import 'package:spacetraders/models/get_status200_response_health.dart';
import 'package:spacetraders/models/get_status200_response_leaderboards.dart';
import 'package:spacetraders/models/get_status200_response_links_inner.dart';
import 'package:spacetraders/models/get_status200_response_server_resets.dart';
import 'package:spacetraders/models/get_status200_response_stats.dart';

/// {@template get_status200_response}
/// Fetched status successfully.
/// {@endtemplate}
@immutable
class GetStatus200Response {
  /// {@macro get_status200_response}
  ...
  /// Converts a `Map<String, dynamic>` to a [GetStatus200Response].
  ...
  /// Converts a [GetStatus200Response] to a `Map<String, dynamic>`.

...
void main() {
  group('ShipRefine201ResponseData', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = ShipRefine201ResponseData.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(ShipRefine201ResponseData.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => ShipRefine201ResponseData.maybeFromJson(<String, dynamic>{}),

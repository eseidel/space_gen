...
void main() {
  group('WarpShip200ResponseData', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = WarpShip200ResponseData(
        nav: ShipNav(
      ...
      final parsed = WarpShip200ResponseData.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(WarpShip200ResponseData.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => WarpShip200ResponseData.maybeFromJson(<String, dynamic>{}),

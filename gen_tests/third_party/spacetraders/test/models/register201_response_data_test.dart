...
void main() {
  group('Register201ResponseData', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = Register201ResponseData(
        token: 'example',
        agent: const Agent(
          accountId: 'example',
          symbol: 'example',
      ...
      final parsed = Register201ResponseData.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(Register201ResponseData.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => Register201ResponseData.maybeFromJson(<String, dynamic>{}),

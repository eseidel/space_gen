...
void main() {
  group('InstallShipModule201Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = InstallShipModule201Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(InstallShipModule201Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => InstallShipModule201Response.maybeFromJson(<String, dynamic>{}),

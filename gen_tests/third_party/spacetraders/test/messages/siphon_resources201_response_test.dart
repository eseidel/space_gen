...
void main() {
  group('SiphonResources201Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = SiphonResources201Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(SiphonResources201Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => SiphonResources201Response.maybeFromJson(<String, dynamic>{}),

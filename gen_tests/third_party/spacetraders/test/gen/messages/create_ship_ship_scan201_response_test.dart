...
void main() {
  group('CreateShipShipScan201Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = CreateShipShipScan201Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(CreateShipShipScan201Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => CreateShipShipScan201Response.maybeFromJson(<String, dynamic>{}),

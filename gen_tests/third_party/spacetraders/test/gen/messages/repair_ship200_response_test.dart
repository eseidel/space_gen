...
void main() {
  group('RepairShip200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = RepairShip200Response(
      ...
      final parsed = RepairShip200Response.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(RepairShip200Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => RepairShip200Response.maybeFromJson(<String, dynamic>{}),

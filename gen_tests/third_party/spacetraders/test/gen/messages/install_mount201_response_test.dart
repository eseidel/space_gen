...
void main() {
  group('InstallMount201Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = InstallMount201Response(
      ...
      final parsed = InstallMount201Response.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(InstallMount201Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => InstallMount201Response.maybeFromJson(<String, dynamic>{}),

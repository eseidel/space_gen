...
void main() {
  group('SupplyConstruction201Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = SupplyConstruction201Response.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(SupplyConstruction201Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => SupplyConstruction201Response.maybeFromJson(<String, dynamic>{}),

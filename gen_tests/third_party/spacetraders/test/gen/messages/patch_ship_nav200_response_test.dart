...
void main() {
  group('PatchShipNav200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = PatchShipNav200Response(
      ...
      final parsed = PatchShipNav200Response.maybeFromJson(instance.toJson())!;
      expect(parsed, equals(instance));
      expect(parsed.hashCode, equals(instance.hashCode));
    });

    test('maybeFromJson returns null on null input', () {
      expect(PatchShipNav200Response.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PatchShipNav200Response.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('PurchaseShip201ResponseData', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = PurchaseShip201ResponseData.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(PurchaseShip201ResponseData.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => PurchaseShip201ResponseData.maybeFromJson(<String, dynamic>{}),

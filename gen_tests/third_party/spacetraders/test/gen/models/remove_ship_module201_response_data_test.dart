...
void main() {
  group('RemoveShipModule201ResponseData', () {
    test('round-trips via maybeFromJson/toJson', () {
      ...
      final parsed = RemoveShipModule201ResponseData.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(RemoveShipModule201ResponseData.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () =>
            RemoveShipModule201ResponseData.maybeFromJson(<String, dynamic>{}),

...
class ExternalScheduledEventPatchRequestPartial {
  ...
  factory ExternalScheduledEventPatchRequestPartial.fromJson(
    ...
    return parseFromJson(
      ...
      () => ExternalScheduledEventPatchRequestPartial(
        ...
        entityMetadata: EntityMetadataExternal.maybeFromJson(
  ...
  static ExternalScheduledEventPatchRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ExternalScheduledEventPatchRequestPartial.fromJson(json);
  }
  ...
  /// Converts an [ExternalScheduledEventPatchRequestPartial]
  ...
  bool operator ==(Object other) {
    ...
    return other is ExternalScheduledEventPatchRequestPartial &&
        status == other.status &&
        name == other.name &&

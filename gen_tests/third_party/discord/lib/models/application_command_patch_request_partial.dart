...
import 'package:discord/models/application_command_patch_request_partial_options_inner.dart';
...
class ApplicationCommandPatchRequestPartial {
  const ApplicationCommandPatchRequestPartial({
    this.name,
  ...
  factory ApplicationCommandPatchRequestPartial.fromJson(
    ...
    return parseFromJson(
      ...
      () => ApplicationCommandPatchRequestPartial(
        ...
        options: (json['options'] as List?)
            ?.map<ApplicationCommandPatchRequestPartialOptionsInner>(
              (e) => ApplicationCommandPatchRequestPartialOptionsInner.fromJson(
  ...
  static ApplicationCommandPatchRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandPatchRequestPartial.fromJson(json);
  }
  ...
  final List<ApplicationCommandPatchRequestPartialOptionsInner>? options;
  ...
  /// Converts an [ApplicationCommandPatchRequestPartial]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandPatchRequestPartial &&
        name == other.name &&

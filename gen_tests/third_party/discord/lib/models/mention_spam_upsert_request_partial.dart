...
import 'package:discord/models/mention_spam_upsert_request_partial_actions_inner.dart';
...
class MentionSpamUpsertRequestPartial {
    ...
    return parseFromJson(
      ...
      () => MentionSpamUpsertRequestPartial(
        ...
        actions: (json['actions'] as List?)
            ?.map<MentionSpamUpsertRequestPartialActionsInner>(
              (e) => MentionSpamUpsertRequestPartialActionsInner.fromJson(
  ...
  static MentionSpamUpsertRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return MentionSpamUpsertRequestPartial.fromJson(json);
  }

  final String? name;
  final AutomodEventType? eventType;
  final List<MentionSpamUpsertRequestPartialActionsInner>? actions;
  final bool? enabled;
  ...
  bool operator ==(Object other) {
    ...
    return other is MentionSpamUpsertRequestPartial &&
        name == other.name &&

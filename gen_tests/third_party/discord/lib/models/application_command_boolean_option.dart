...
@immutable
class ApplicationCommandBooleanOption {
  const ApplicationCommandBooleanOption({
    required this.name,
  ...
  factory ApplicationCommandBooleanOption.fromJson(Map<String, dynamic> json) {
  ...
  static ApplicationCommandBooleanOption? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandBooleanOption.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandBooleanOption] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandBooleanOption &&
        name == other.name &&

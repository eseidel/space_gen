...
class VoiceScheduledEventPatchRequestPartial {
  const VoiceScheduledEventPatchRequestPartial({
    this.status,
    this.name,
    this.description,
    this.image,
  ...
  factory VoiceScheduledEventPatchRequestPartial.fromJson(
  ...
  static VoiceScheduledEventPatchRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return VoiceScheduledEventPatchRequestPartial.fromJson(json);
  }
  ...
  /// Converts a [VoiceScheduledEventPatchRequestPartial]
  ...
  bool operator ==(Object other) {
    ...
    return other is VoiceScheduledEventPatchRequestPartial &&
        status == other.status &&
        name == other.name &&

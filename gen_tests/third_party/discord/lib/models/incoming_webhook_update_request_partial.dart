...
import 'package:discord/models/incoming_webhook_update_request_partial_components_inner.dart';
import 'package:discord/models/rich_embed.dart';
import 'package:meta/meta.dart';

@immutable
class IncomingWebhookUpdateRequestPartial {
  const IncomingWebhookUpdateRequestPartial({
    this.content,
    this.embeds,
  ...
  factory IncomingWebhookUpdateRequestPartial.fromJson(
    ...
    return parseFromJson(
      ...
      () => IncomingWebhookUpdateRequestPartial(
        ...
        components: (json['components'] as List?)
            ?.map<IncomingWebhookUpdateRequestPartialComponentsInner>(
              (e) =>
                  IncomingWebhookUpdateRequestPartialComponentsInner.fromJson(
  ...
  static IncomingWebhookUpdateRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return IncomingWebhookUpdateRequestPartial.fromJson(json);
  }

  final String? content;
  final List<RichEmbed>? embeds;
  final MessageAllowedMentionsRequest? allowedMentions;
  final List<IncomingWebhookUpdateRequestPartialComponentsInner>? components;
  final List<MessageAttachmentRequest>? attachments;
  final PollCreateRequest? poll;
  final int? flags;

  /// Converts an [IncomingWebhookUpdateRequestPartial]
  ...
  bool operator ==(Object other) {
    ...
    return other is IncomingWebhookUpdateRequestPartial &&

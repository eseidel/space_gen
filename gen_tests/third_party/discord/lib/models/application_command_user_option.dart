...
class ApplicationCommandUserOption {
  const ApplicationCommandUserOption({
    required this.name,
  ...
  factory ApplicationCommandUserOption.fromJson(Map<String, dynamic> json) {
  ...
  static ApplicationCommandUserOption? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandUserOption.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandUserOption] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandUserOption &&
        name == other.name &&

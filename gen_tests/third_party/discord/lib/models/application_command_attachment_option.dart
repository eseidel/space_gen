...
class ApplicationCommandAttachmentOption {
  ...
  /// [ApplicationCommandAttachmentOption].
  factory ApplicationCommandAttachmentOption.fromJson(
  ...
  static ApplicationCommandAttachmentOption? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandAttachmentOption.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandAttachmentOption]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandAttachmentOption &&
        name == other.name &&

...
import 'package:discord/models/default_keyword_list_upsert_request_partial_actions_inner.dart';
import 'package:discord/models/snowflake_type.dart';
import 'package:meta/meta.dart';

@immutable
class DefaultKeywordListUpsertRequestPartial {
  const DefaultKeywordListUpsertRequestPartial({
    this.name,
    this.eventType,
    this.actions,
    this.enabled,
  ...
  factory DefaultKeywordListUpsertRequestPartial.fromJson(
    ...
    return parseFromJson(
      ...
      () => DefaultKeywordListUpsertRequestPartial(
        ...
        actions: (json['actions'] as List?)
            ?.map<DefaultKeywordListUpsertRequestPartialActionsInner>(
              (e) =>
                  DefaultKeywordListUpsertRequestPartialActionsInner.fromJson(
  ...
  static DefaultKeywordListUpsertRequestPartial? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return DefaultKeywordListUpsertRequestPartial.fromJson(json);
  }

  final String? name;
  final AutomodEventType? eventType;
  final List<DefaultKeywordListUpsertRequestPartialActionsInner>? actions;
  final bool? enabled;
  ...
  bool operator ==(Object other) {
    ...
    return other is DefaultKeywordListUpsertRequestPartial &&
        name == other.name &&

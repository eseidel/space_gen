...
class UpdateRoleRequestPartial {
  ...
  static UpdateRoleRequestPartial? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return UpdateRoleRequestPartial.fromJson(json);
  }
  ...
  /// Converts a [UpdateRoleRequestPartial] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is UpdateRoleRequestPartial &&
        name == other.name &&

...
class ApplicationCommandChannelOption {
  ...
  static ApplicationCommandChannelOption? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandChannelOption.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandChannelOption] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandChannelOption &&
        name == other.name &&

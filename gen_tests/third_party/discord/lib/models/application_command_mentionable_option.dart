...
@immutable
class ApplicationCommandMentionableOption {
  const ApplicationCommandMentionableOption({
    required this.name,
  ...
  factory ApplicationCommandMentionableOption.fromJson(
  ...
  static ApplicationCommandMentionableOption? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandMentionableOption.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandMentionableOption]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandMentionableOption &&
        name == other.name &&

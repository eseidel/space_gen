import 'package:discord/messages/spam_link_trigger_metadata_response.dart';
...
import 'package:discord/models/spam_link_rule_response_actions_inner.dart';
import 'package:meta/meta.dart';

@immutable
class SpamLinkRuleResponse {
  const SpamLinkRuleResponse({
    required this.id,
  ...
  /// Converts a `Map<String, dynamic>` to a [SpamLinkRuleResponse].
  factory SpamLinkRuleResponse.fromJson(Map<String, dynamic> json) {
    return parseFromJson(
      ...
      () => SpamLinkRuleResponse(
        ...
        actions: (json['actions'] as List)
            .map<SpamLinkRuleResponseActionsInner>(
              (e) => SpamLinkRuleResponseActionsInner.fromJson(
        ...
        exemptChannels: (json['exempt_channels'] as List)
            .map<SnowflakeType>((e) => SnowflakeType.fromJson(e as String))
            .toList(),
        triggerMetadata: SpamLinkTriggerMetadataResponse.fromJson(
  ...
  static SpamLinkRuleResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return SpamLinkRuleResponse.fromJson(json);
  }
  ...
  final List<SpamLinkRuleResponseActionsInner> actions;
  AutomodTriggerType get triggerType => AutomodTriggerType.spamLink;
  final bool enabled;
  final List<SnowflakeType> exemptRoles;
  final List<SnowflakeType> exemptChannels;
  final SpamLinkTriggerMetadataResponse triggerMetadata;

  /// Converts a [SpamLinkRuleResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is SpamLinkRuleResponse &&
        id == other.id &&

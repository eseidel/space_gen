...
class ScheduledEventResponse {
  ...
  /// Converts a `Map<String, dynamic>` to a [ScheduledEventResponse].
  factory ScheduledEventResponse.fromJson(Map<String, dynamic> json) {
    return parseFromJson(
      ...
      () => ScheduledEventResponse(
        ...
        entityType: GuildScheduledEventEntityTypes.fromJson(
  ...
  static ScheduledEventResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return ScheduledEventResponse.fromJson(json);
  }
  ...
  /// Converts a [ScheduledEventResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ScheduledEventResponse &&
        id == other.id &&

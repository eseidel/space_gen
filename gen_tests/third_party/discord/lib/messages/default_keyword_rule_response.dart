import 'package:discord/messages/default_keyword_list_trigger_metadata_response.dart';
import 'package:discord/model_helpers.dart';
import 'package:discord/models/automod_event_type.dart';
import 'package:discord/models/automod_trigger_type.dart';
import 'package:discord/models/default_keyword_rule_response_actions_inner.dart';
import 'package:discord/models/snowflake_type.dart';
import 'package:meta/meta.dart';

@immutable
class DefaultKeywordRuleResponse {
  const DefaultKeywordRuleResponse({
    required this.id,
  ...
  /// Converts a `Map<String, dynamic>` to a [DefaultKeywordRuleResponse].
  factory DefaultKeywordRuleResponse.fromJson(Map<String, dynamic> json) {
    return parseFromJson(
      ...
      () => DefaultKeywordRuleResponse(
        ...
        actions: (json['actions'] as List)
            .map<DefaultKeywordRuleResponseActionsInner>(
        ...
        exemptChannels: (json['exempt_channels'] as List)
            .map<SnowflakeType>((e) => SnowflakeType.fromJson(e as String))
            .toList(),
        triggerMetadata: DefaultKeywordListTriggerMetadataResponse.fromJson(
  ...
  static DefaultKeywordRuleResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return DefaultKeywordRuleResponse.fromJson(json);
  }
  ...
  final DefaultKeywordListTriggerMetadataResponse triggerMetadata;

  /// Converts a [DefaultKeywordRuleResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is DefaultKeywordRuleResponse &&
        id == other.id &&

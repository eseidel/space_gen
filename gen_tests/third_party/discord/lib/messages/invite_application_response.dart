...
class InviteApplicationResponse {
  ...
  static InviteApplicationResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return InviteApplicationResponse.fromJson(json);
  }
  ...
  /// Converts an [InviteApplicationResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is InviteApplicationResponse &&
        id == other.id &&
        name == other.name &&
        icon == other.icon &&

...
@immutable
class ApplicationRoleConnectionsMetadataItemResponse {
  const ApplicationRoleConnectionsMetadataItemResponse({
    required this.type,
    required this.key,
    required this.name,
  ...
  factory ApplicationRoleConnectionsMetadataItemResponse.fromJson(
  ...
  static ApplicationRoleConnectionsMetadataItemResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationRoleConnectionsMetadataItemResponse.fromJson(json);
  }
  ...
  /// Converts an [ApplicationRoleConnectionsMetadataItemResponse]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationRoleConnectionsMetadataItemResponse &&
        type == other.type &&
        key == other.key &&
        name == other.name &&

...
class ApplicationCommandChannelOptionResponse {
  ...
  /// [ApplicationCommandChannelOptionResponse].
  factory ApplicationCommandChannelOptionResponse.fromJson(
  ...
  static ApplicationCommandChannelOptionResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandChannelOptionResponse.fromJson(json);
  }

  ApplicationCommandOptionType get type => ApplicationCommandOptionType.channel;
  final String name;
  ...
  /// Converts an [ApplicationCommandChannelOptionResponse]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandChannelOptionResponse &&
        name == other.name &&

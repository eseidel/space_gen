...
@immutable
class ApplicationCommandMentionableOptionResponse {
  const ApplicationCommandMentionableOptionResponse({
    required this.name,
  ...
  factory ApplicationCommandMentionableOptionResponse.fromJson(
  ...
  static ApplicationCommandMentionableOptionResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandMentionableOptionResponse.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandMentionableOptionResponse]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandMentionableOptionResponse &&
        name == other.name &&

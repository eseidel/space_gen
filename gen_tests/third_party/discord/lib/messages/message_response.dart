...
import 'package:discord/models/message_response_components_inner.dart';
import 'package:discord/models/message_response_interaction_metadata.dart';
import 'package:discord/models/message_response_nonce.dart';
import 'package:discord/models/message_response_stickers_inner.dart';
...
class MessageResponse {
  ...
  /// Converts a `Map<String, dynamic>` to a [MessageResponse].
    ...
    return parseFromJson(
      ...
      () => MessageResponse(
        ...
        components: (json['components'] as List)
            .map<MessageResponseComponentsInner>(
              (e) => MessageResponseComponentsInner.fromJson(
                e as Map<String, dynamic>,
              ),
            )
            .toList(),
        stickers: (json['stickers'] as List?)
            ?.map<MessageResponseStickersInner>(
              (e) => MessageResponseStickersInner.fromJson(
                e as Map<String, dynamic>,
              ),
            )
            .toList(),
        ...
        nonce: MessageResponseNonce.maybeFromJson(
        ...
        interactionMetadata: MessageResponseInteractionMetadata.maybeFromJson(
  ...
  static MessageResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
  ...
  final int flags;
  final List<MessageResponseComponentsInner> components;
  final List<MessageResponseStickersInner>? stickers;
  ...
  final MessageResponseNonce? nonce;
  ...
  final MessageResponseInteractionMetadata? interactionMetadata;
  ...
  /// Converts a [MessageResponse] to a `Map<String, dynamic>`.

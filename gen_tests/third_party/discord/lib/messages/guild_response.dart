...
class GuildResponse {
  ...
  /// Converts a `Map<String, dynamic>` to a [GuildResponse].
  ...
  static GuildResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return GuildResponse.fromJson(json);
  }
  ...
  /// Converts a [GuildResponse] to a `Map<String, dynamic>`.

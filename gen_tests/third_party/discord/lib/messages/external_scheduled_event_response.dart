import 'package:discord/messages/entity_metadata_external_response.dart';
...
class ExternalScheduledEventResponse {
  const ExternalScheduledEventResponse({
    required this.id,
  ...
  /// Converts a `Map<String, dynamic>` to an [ExternalScheduledEventResponse].
  factory ExternalScheduledEventResponse.fromJson(Map<String, dynamic> json) {
    return parseFromJson(
      ...
      () => ExternalScheduledEventResponse(
        ...
        entityMetadata: EntityMetadataExternalResponse.fromJson(
  ...
  static ExternalScheduledEventResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ExternalScheduledEventResponse.fromJson(json);
  }
  ...
  /// Converts an [ExternalScheduledEventResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is ExternalScheduledEventResponse &&
        id == other.id &&

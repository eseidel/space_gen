import 'package:discord/messages/application_command_option_string_choice_response.dart';
import 'package:discord/model_helpers.dart';
import 'package:discord/models/application_command_option_type.dart';
import 'package:meta/meta.dart';

@immutable
class ApplicationCommandStringOptionResponse {
  const ApplicationCommandStringOptionResponse({
    required this.name,
  ...
  factory ApplicationCommandStringOptionResponse.fromJson(
    ...
    return parseFromJson(
      ...
      () => ApplicationCommandStringOptionResponse(
        ...
        choices: (json['choices'] as List?)
            ?.map<ApplicationCommandOptionStringChoiceResponse>(
  ...
  static ApplicationCommandStringOptionResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandStringOptionResponse.fromJson(json);
  }
  ...
  /// Converts an [ApplicationCommandStringOptionResponse]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandStringOptionResponse &&
        name == other.name &&

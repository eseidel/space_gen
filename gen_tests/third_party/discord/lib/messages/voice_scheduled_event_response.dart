import 'package:discord/messages/entity_metadata_voice_response.dart';
...
class VoiceScheduledEventResponse {
  const VoiceScheduledEventResponse({
    required this.id,
  ...
  /// Converts a `Map<String, dynamic>` to a [VoiceScheduledEventResponse].
  factory VoiceScheduledEventResponse.fromJson(Map<String, dynamic> json) {
    return parseFromJson(
      ...
      () => VoiceScheduledEventResponse(
        ...
        entityMetadata: EntityMetadataVoiceResponse.maybeFromJson(
  ...
  static VoiceScheduledEventResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return VoiceScheduledEventResponse.fromJson(json);
  }
  ...
  final EntityMetadataVoiceResponse? entityMetadata;

  /// Converts a [VoiceScheduledEventResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is VoiceScheduledEventResponse &&
        id == other.id &&

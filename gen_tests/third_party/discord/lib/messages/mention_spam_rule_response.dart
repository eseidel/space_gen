...
import 'package:discord/models/mention_spam_rule_response_actions_inner.dart';
...
class MentionSpamRuleResponse {
    ...
    return parseFromJson(
      ...
      () => MentionSpamRuleResponse(
        ...
        actions: (json['actions'] as List)
            .map<MentionSpamRuleResponseActionsInner>(
              (e) => MentionSpamRuleResponseActionsInner.fromJson(
        ...
        exemptChannels: (json['exempt_channels'] as List)
            .map<SnowflakeType>((e) => SnowflakeType.fromJson(e as String))
            .toList(),
        triggerMetadata: MentionSpamTriggerMetadataResponse.fromJson(
  ...
  static MentionSpamRuleResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return MentionSpamRuleResponse.fromJson(json);
  }
  ...
  final List<MentionSpamRuleResponseActionsInner> actions;
  ...
  /// Converts a [MentionSpamRuleResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is MentionSpamRuleResponse &&
        id == other.id &&

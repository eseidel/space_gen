...
class GuildIncomingWebhookResponse {
  const GuildIncomingWebhookResponse({
  ...
  /// Converts a `Map<String, dynamic>` to a [GuildIncomingWebhookResponse].
  factory GuildIncomingWebhookResponse.fromJson(Map<String, dynamic> json) {
  ...
  static GuildIncomingWebhookResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return GuildIncomingWebhookResponse.fromJson(json);
  }
  ...
  final String name;
  WebhookTypes get type => WebhookTypes.guildIncoming;
  final UserResponse? user;
  final String? token;
  final Uri? url;

  /// Converts a [GuildIncomingWebhookResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is GuildIncomingWebhookResponse &&

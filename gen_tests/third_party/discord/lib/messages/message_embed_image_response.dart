...
@immutable
class MessageEmbedImageResponse {
  const MessageEmbedImageResponse({
    this.url,
    this.proxyUrl,
    this.width,
    this.height,
  ...
  /// Converts a `Map<String, dynamic>` to a [MessageEmbedImageResponse].
  factory MessageEmbedImageResponse.fromJson(Map<String, dynamic> json) {
  ...
  static MessageEmbedImageResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return MessageEmbedImageResponse.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is MessageEmbedImageResponse &&
        url == other.url &&

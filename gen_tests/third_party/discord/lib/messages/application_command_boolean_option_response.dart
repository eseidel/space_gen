...
@immutable
class ApplicationCommandBooleanOptionResponse {
  const ApplicationCommandBooleanOptionResponse({
    required this.name,
  ...
  factory ApplicationCommandBooleanOptionResponse.fromJson(
  ...
  static ApplicationCommandBooleanOptionResponse? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ApplicationCommandBooleanOptionResponse.fromJson(json);
  }

  ApplicationCommandOptionType get type => ApplicationCommandOptionType.boolean;
  final String name;
  ...
  /// Converts an [ApplicationCommandBooleanOptionResponse]
  ...
  bool operator ==(Object other) {
    ...
    return other is ApplicationCommandBooleanOptionResponse &&
        name == other.name &&

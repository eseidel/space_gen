...
import 'package:discord/models/message_create_request_components_inner.dart';
import 'package:discord/models/message_create_request_nonce.dart';
...
class MessageCreateRequest {
  ...
  /// Converts a `Map<String, dynamic>` to a [MessageCreateRequest].
    ...
    return parseFromJson(
      ...
      () => MessageCreateRequest(
        ...
        components: (json['components'] as List?)
            ?.map<MessageCreateRequestComponentsInner>(
              (e) => MessageCreateRequestComponentsInner.fromJson(
        ...
        nonce: MessageCreateRequestNonce.maybeFromJson(
  ...
  static MessageCreateRequest? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return MessageCreateRequest.fromJson(json);
  }
  ...
  final List<MessageCreateRequestComponentsInner>? components;
  final int? flags;
  ...
  final MessageCreateRequestNonce? nonce;
  final bool? enforceNonce;
  final bool? tts;

  /// Converts a [MessageCreateRequest] to a `Map<String, dynamic>`.

...
class MessageAttachmentResponse {
  ...
  /// Converts a `Map<String, dynamic>` to a [MessageAttachmentResponse].
  ...
  static MessageAttachmentResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return MessageAttachmentResponse.fromJson(json);
  }
  ...
  /// Converts a [MessageAttachmentResponse] to a `Map<String, dynamic>`.
  Map<String, dynamic> toJson() {
    return {
      ...
      if (placeholderVersion != null) 'placeholder_version': placeholderVersion,
      'title': title,
      if (application != null) 'application': application?.toJson(),
      if (clipCreatedAt != null)
        'clip_created_at': clipCreatedAt?.toIso8601String(),
      if (clipParticipants != null)

...
class CreatedThreadResponse {
  ...
  /// Converts a `Map<String, dynamic>` to a [CreatedThreadResponse].
  factory CreatedThreadResponse.fromJson(Map<String, dynamic> json) {
  ...
  static CreatedThreadResponse? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return CreatedThreadResponse.fromJson(json);
  }
  ...
  /// Converts a [CreatedThreadResponse] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is CreatedThreadResponse &&
        id == other.id &&
        type == other.type &&

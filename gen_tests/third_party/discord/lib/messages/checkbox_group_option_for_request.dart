...
class CheckboxGroupOptionForRequest {
  ...
  static CheckboxGroupOptionForRequest? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return CheckboxGroupOptionForRequest.fromJson(json);
  }
  ...
  /// Converts a [CheckboxGroupOptionForRequest] to a `Map<String, dynamic>`.
  ...
  bool operator ==(Object other) {
    ...
    return other is CheckboxGroupOptionForRequest &&
        label == other.label &&
        value == other.value &&

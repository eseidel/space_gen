...
void main() {
  group('GuildTemplateSnapshotResponse', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = GuildTemplateSnapshotResponse(
        name: 'example',
        description: 'example',
        region: 'example',
      ...
      final parsed = GuildTemplateSnapshotResponse.maybeFromJson(
        instance.toJson(),
      )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(GuildTemplateSnapshotResponse.maybeFromJson(null), isNull);
    });

    test('maybeFromJson throws FormatException on invalid input', () {
      expect(
        () => GuildTemplateSnapshotResponse.maybeFromJson(<String, dynamic>{}),

...
void main() {
  group('ModalInteractionCallbackRequestDataComponentsInner', () {
    test(
      ...
      () {
        ...
        final parsed = ActionRowComponentForModalRequest.maybeFromJson(
          instance.toJson(),
        )!;
    ...
    test('maybeFromJson returns null on null input', () {
      expect(
        ModalInteractionCallbackRequestDataComponentsInner.maybeFromJson(null),
        isNull,
      );
    });
  });

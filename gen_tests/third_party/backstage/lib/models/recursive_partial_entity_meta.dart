...
class RecursivePartialEntityMeta {
  const RecursivePartialEntityMeta({
  ...
  /// Converts a `Map<String, dynamic>` to a [RecursivePartialEntityMeta].
  factory RecursivePartialEntityMeta.fromJson(Map<String, dynamic> json) {
  ...
  static RecursivePartialEntityMeta? maybeFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    return RecursivePartialEntityMeta.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RecursivePartialEntityMeta &&
